...
| Claude-to-Kiro | `claude-to-kiro/` | Converts Claude Code configurations (skills, CLAUDE.md, hooks, MCP servers) into AWS Kiro IDE/CLI equivalents using signal-based content classification and tool name translation. Supports four conversion workflows: single skill, full project, global config, and plugin-to-power bundle. | "Convert my deployment skill to Kiro", "Migrate this project's Claude setup to Kiro", "Port my global Claude config to AWS Kiro", "Convert my Claude plugins to a Kiro power bundle" |
